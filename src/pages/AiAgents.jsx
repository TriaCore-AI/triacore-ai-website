...
export default function AiAgents() {
    ...
    return (
        <div ref={containerRef} className="relative w-full min-h-screen bg-background text-foreground font-sans selection:bg-foreground selection:text-background">
            ...
            <section className="relative min-h-[70vh] w-full flex flex-col items-center justify-start pt-64 pb-16 px-6 md:px-16 bg-white overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center">
                    ...
                    <div className="text-center mb-12 hero-animate">
                        <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl font-semibold tracking-tight text-foreground mb-6">
                            AI Agents
                        </h1>
